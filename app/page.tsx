...
export default function Home() {
  return (
    <main className="min-h-screen">
      ...
      {/* Hero Section */}
      <section className="relative min-h-[75vh] flex items-center justify-center px-4 sm:px-6 lg:px-8">
        ...
        {/* Hero Content */}
        <div className="relative z-20 text-center max-w-4xl mx-auto animate-slide-up">
